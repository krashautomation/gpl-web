      ...
      <div className="grid grid-cols-1 gap-6 mb-8">
        <Card className=" border-neutral-800">
          ...
          <CardContent>
            ...
            <p className="text-base mb-3">
              Today I believe real wealth grows through genuine connection, bold idea-sharing, and
              creative partnerships—let's talk gold, markets, or your next big move.
            </p>

            <p className="text-base mb-3">
              If you want to see more of my writings signup below. Otherwise, keep reading for my
              contact information.
            </p>
