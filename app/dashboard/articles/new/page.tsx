...
import { ImportArticleModal } from '@/app/components/ImportArticleModal';
...
export default function NewArticlePage() {
  ...
  // Called when ImportArticleModal finishes — pre-fills form fields
  ...
  return (
    <div className="max-w-[1000px] mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        <ImportArticleModal onImport={handleImport} />
      </div>
