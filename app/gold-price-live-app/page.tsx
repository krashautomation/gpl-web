            ...
            <div className="overflow-x-auto">
              <div className="flex flex-col items-center px-6 py-8">
                ...
                <p className="text-base  leading-relaxed text-center max-w-lg mb-8">
                  Stay ahead of the market with live gold prices, silver prices, and major market
                  indexes — updated in real time on your Android device.
                </p>

                <p className="text-sm  font-medium mb-4">Current features:</p>
                ...
                <p className="text-base  font-semibold mb-3">More powerful features coming soon:</p>

                <p className="text-sm  text-center mb-8 max-w-md">
                  Portfolio tracking • Price alerts • Interactive charts • Historical data • And
                  much more…
                </p>
