    ...
    <MainLayout>
      ...
      <div className="container mx-auto px-4 py-12">
              ...
              <Card className=" border-neutral-800 h-full hover:border-yellow-500 transition-colors group">
                <CardHeader>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <CardTitle className=" ">{chart.title}</CardTitle>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl font-bold  mb-4">Understanding Gold Charts</h2>
          <p className=" mb-6">
            Our charts display real-time data from global markets. Use different timeframes to
            analyze short-term volatility or long-term trends. The charts update automatically to
            reflect the latest market prices.
          </p>
          <Link href="/news/understanding-gold-price-charts" className=" hover:underline">
